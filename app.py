...
if mode == "👤 Enumerator":
        ...
        with st.spinner(
            ...
            try:
                ...
                if rows.empty:
                    ...
                    st.success(
                        "✅ Enumerator data loaded successfully."
                    )
    ...
    if (
        ...
        st.info(
            "👆 Select an Enumerator and click SEARCH to view the full details."
        )
        ...
        if st.button(
            ...
            if status == "IN PROGRESS":
                ...
                if not remarks.strip():
                    ...
                    st.error(
                        "⚠️ Remarks are compulsory for IN PROGRESS."
                    )
